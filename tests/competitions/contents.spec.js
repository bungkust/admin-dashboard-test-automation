...
test.describe('Contents Module', () => {
  ...
  test.beforeEach(async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.goto();
  });

  test('TC-CONTENT-001 - Load contents list page', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await expect(loggedInPage.locator('table')).toBeVisible();
  });

  test('TC-CONTENT-002 - Search content by title', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.search('Test');
    await expect(loggedInPage.locator('table')).toContainText('Test');
  });

  test('TC-CONTENT-003 - Clear search returns all contents', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.search('Test');
  ...
  test('TC-CONTENT-004 - Filter content by type', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
  ...
  test('TC-CONTENT-005 - Navigate to new content form', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
  ...
  test('TC-CONTENT-006 - Create content with valid data', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
  ...
  test('TC-CONTENT-007 - Create content with only required fields', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-008 - Create content with empty title shows error', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
    await contentsPage.selectType('Article');
  ...
  test('TC-CONTENT-009 - Create content with empty body shows error', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-010 - Create content with empty type shows error', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-011 - Cancel content creation returns to list', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-012 - Back to contents from create page', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-013 - Edit existing content', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-014 - Delete content from list', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-015 - Cancel delete returns to list without deletion', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    const rows = await contentsPage.getTableRows();
    const initialCount = await rows.count();
    const firstRow = rows.first();
  ...
  test('TC-CONTENT-016 - Create content with special characters in title', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-017 - Create content with maximum length title', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-018 - Create content with valid media URL', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-019 - Create content with author name', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-020 - Create content with published date', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-021 - Edit content and cancel changes', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.gotoNew();
  ...
  test('TC-CONTENT-022 - Verify content list table headers', async ({ loggedInPage }) => {
    await expect(loggedInPage.locator('table thead')).toBeVisible();
  });

  test('TC-CONTENT-023 - Pagination on content list', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
  ...
  test('TC-CONTENT-024 - Next pagination button works', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.clickNextPagination();
    await expect(loggedInPage.locator('table')).toBeVisible();
  });

  test('TC-CONTENT-025 - Previous pagination button works', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
    await contentsPage.clickNextPagination();
  ...
  test('TC-CONTENT-026 - Empty state displayed when no contents match search', async ({ loggedInPage }) => {
    const contentsPage = new ContentsPage(loggedInPage);
